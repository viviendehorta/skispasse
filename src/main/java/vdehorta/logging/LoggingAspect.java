...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(vdehorta.repository..*)"+
        " || within(vdehorta.service..*)"+
        " || within(vdehorta.web.rest..*)")
    ...
    public void logAfterThrowing(JoinPoint joinPoint, Throwable e) {
        if (env.acceptsProfiles(Profiles.of(ProfileConstants.SPRING_PROFILE_DEV))) {
