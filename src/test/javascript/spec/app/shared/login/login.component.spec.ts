...
import { SkisLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: SkisLoginModalComponent;
    let fixture: ComponentFixture<SkisLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [SkisLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(SkisLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(SkisLoginModalComponent);
